...
const MessageBar = ({submitTextAndQuickMessage})=>{
            ...
            <div className='flex flex-col-reverse'>
                ...
                {textMessage.isEmpty() &&
                    <div className='flex flex-row'>
                        <svg className="m-1 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
